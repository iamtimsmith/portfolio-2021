...
description: I'll teach you how to use state in a React component when using classes
published: true
---
...
<video
  src='https://media.giphy.com/media/d2Z9QYzA2aidiWn6/giphy.mp4'
  playsinline
  autoplay
  loop
  muted
...
<video
  src='https://media.giphy.com/media/3owzW5c1tPq63MPmWk/giphy.mp4'
  playsinline
  autoplay
  loop
  muted
