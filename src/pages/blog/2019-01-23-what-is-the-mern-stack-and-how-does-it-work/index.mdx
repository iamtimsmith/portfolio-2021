...
description: Learn the basics of building a site using MongoDB, Express, React, and Node
published: true
---
...
<video
  src='https://media.giphy.com/media/tO5ddHjpXB6lG/giphy.mp4'
  playsinline
  autoplay
  loop
  muted
...
<video
  src='https://media.giphy.com/media/5wFkqt6A8R4qAqGIFQ/giphy.mp4'
  playsinline
  autoplay
  loop
  muted
