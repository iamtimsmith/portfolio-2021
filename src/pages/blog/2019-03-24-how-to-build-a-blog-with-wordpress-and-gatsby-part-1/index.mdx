...
description: I'll show you how to get WordPress ready to integrate with Gatsby
published: true
---
...
<article class='message'>
  <div class='message-body'>
    Note: This is part one in a series of posts about Gatsby.js and WordPress.
    You can find{' '}
    <a href='/blog/how-to-build-a-blog-with-wordpress-and-gatsby-part-2'>
      Part Two here
    </a>
    , and <a href='/blog/how-to-build-a-blog-with-wordpress-and-gatsby-part-3'>
      Part Three here
    </a>.
  </div>
</article>
...
<video
  src='https://media.giphy.com/media/CBFgxojcXwac/giphy.mp4'
  playsinline
  autoplay
  muted
  loop
...
<video
  src='https://media.giphy.com/media/xUOwGmsFStnxzIGC2s/giphy.mp4'
  playsinline
  autoplay
  muted
  loop
...
<video
  src='https://media.giphy.com/media/qyX9oq2ZmsPwk/giphy.mp4'
  playsinline
  autoplay
  muted
  loop
