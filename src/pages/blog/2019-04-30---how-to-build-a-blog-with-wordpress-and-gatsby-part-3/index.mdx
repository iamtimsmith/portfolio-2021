...
description: Create pages from templates and components with data from WordPress
published: true
---
...
<article class='message'>
  <div class='message-body'>
    Note: This is part three in a series of posts about Gatsby.js and WordPress.
    You can find{' '}
    <a href='/blog/how-to-build-a-blog-with-wordpress-and-gatsby-part-1'>
      Part One here
    </a>
    , and <a href='/blog/how-to-build-a-blog-with-wordpress-and-gatsby-part-2'>
      Part Two here
    </a>.
  </div>
</article>
