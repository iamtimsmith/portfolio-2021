...
tags: [wordpress, cms]
image: ./featured_image.jpeg
description: Learn how to build a website with ease by using WordPress as a CMS
published: true
---
...
![The WordPress logo on a rocket illustration.](wordpress.png)
...
![Installing WordPress through a cPanel interface.](hostgator.png)
...
![Select the domain for installation. This will be the address for your website.](install.png)
...
![Choose settings for your WordPress site.](settings.png)
...
![Congratulations! Your installation is complete!](details.png)
...
![Now that your site is set up, login to Wordpress.](login.png)
...
![You can customize your logo, menus, and other settings through the WordPress Customizer.](customizer.png)
...
![You can change the appearance of your site by changing themes.](theme.png)
...
![Don't see the theme you're looking for? You can add themes as well.](add_themes.png)
...
![You can add as many pages as you need. Pages should be pages on your site which have static information (About Us, Contact, Privacy Policy, etc).](add_pages.png)
